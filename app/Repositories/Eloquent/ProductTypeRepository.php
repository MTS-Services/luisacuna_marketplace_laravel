...
class ProductTypeRepository implements ProductTypeRepositoryInterface
{
    ...
    * ================== ================== ================== */
    ...
    public function find($column_value, string $column_name = 'id',  bool $trashed = false): ?ProductType
    {
        $model = $this->model;
        if ($trashed) {
    ...
    public function findTrashed($column_value, string $column_name = 'id'): ?ProductType
    {
    ...
    public function paginate(int $perPage = 15, array $filters = []): LengthAwarePaginator
    {
        ...
        if ($search) {
            // Scout Search
            return ProductType::search($search)
    ...
    * ================== ================== ================== */
    ...
    public function restore(int $id, int $actionerId): bool
    {
        ...
        $productType->update(['restored_by' => $actionerId, 'restored_at' => now()]);
