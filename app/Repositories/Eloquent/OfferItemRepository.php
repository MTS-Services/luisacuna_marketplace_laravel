...
class OfferItemRepository implements OfferItemRepositoryInterface
{
    /**
     * Create a new class instance.
     */
    public function __construct(
        protected OfferItem $model
    ) {}
    ...
    * ================== ================== ================== */
    ...
    public function find($column_value, string $column_name = 'id',  bool $trashed = false): ?OfferItem
    {
        $model = $this->model;
        if ($trashed) {
    ...
    public function findTrashed($column_value, string $column_name = 'id'): ?OfferItem
    {
    ...
    public function paginate(int $perPage = 15, array $filters = []): LengthAwarePaginator
    {
        ...
        if ($search) {
            // Scout Search
            return OfferItem::search($search)
    ...
    * ================== ================== ================== */
    ...
    public function create(array $data): OfferItem
    {
