...
class SellerKycService
{
    ...
    * ================== ================== ================== */
    ...
    public function findData($column_value, string $column_name = 'id',  bool $trashed = false): ?SellerKyc
    {
        $model = $this->model;
        if ($trashed) {
    ...
    public function getFristData(array $filters = [], $sortField = 'created_at', $order = 'desc'): ?SellerKyc
    {
        $query = $this->model->query();
    ...
    public function getPaginatedData(int $perPage =  15, array $filters = []): LengthAwarePaginator
    {
        ...
        if ($search) {
            // Scout Search
            return SellerKyc::search($search)
