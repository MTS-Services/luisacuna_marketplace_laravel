...
class TagService
{
    ...
    public function __construct(
        protected TagRepositoryInterface $interface,
    ...
    public function findData($column_value, string $column_name = 'id'): ?Tag
    {
    ...
    public function createData(array $data): Tag
    {
        return $this->createAction->execute($data);
    }

    public function updateData(int $id, array $data): Tag
    {
    ...
    public function updateStatusData(int $id, TagStatus $status, ?int $actionerId = null): Tag
    {
        if ($actionerId == null) {
            $actionerId = admin()->id;
        }
    ...
    public function bulkUpdateStatus(array $ids, TagStatus $status, ?int $actionerId = null): int
    {
        if ($actionerId == null) {
            $actionerId = admin()->id;
        }
