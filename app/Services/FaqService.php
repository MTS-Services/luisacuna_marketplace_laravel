...
class FaqService
{
    ...
    public function updateStatusData(int $id, FaqStatus $status, ?int $actionerId = null): Faq
    {
        if ($actionerId == null) {
            $actionerId = admin()->id;
        }
    ...
    public function bulkUpdateStatus(array $ids, FaqStatus $status, ?int $actionerId = null): int
    {
        if ($actionerId == null) {
            $actionerId = admin()->id;
        }
