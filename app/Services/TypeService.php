...
use App\Actions\Type\BulkAction;
use App\Actions\Type\CreateAction;
use App\Actions\Type\DeleteAction;
use App\Actions\Type\RestoreAction;
use App\Actions\Type\UpdateAction;
...
class TypeService
{
    ...
    public function __construct(
        protected TypeRepositoryInterface $interface,
    ...
    public function findData($column_value, string $column_name = 'id'): ?Type
    {
    ...
    public function createData(array $data): Type
    {
        return $this->createAction->execute($data);
    }

    public function updateData(int $id, array $data): Type
    {
    ...
    public function updateStatusData(int $id, TypeStatus $status, ?int $actionerId = null): Type
    {
        if ($actionerId == null) {
            $actionerId = admin()->id;
        }
    ...
    public function bulkUpdateStatus(array $ids, TypeStatus $status, ?int $actionerId = null): int
    {
        if ($actionerId == null) {
            $actionerId = admin()->id;
        }
