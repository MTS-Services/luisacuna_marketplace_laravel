...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.backend.admin.reward-management.achievement.index', [
            'datas' => $datas,
            'columns' => $columns,
            'actions' => $actions,
    ...
    {
        try {
            $dataStatus = AchievementStatus::from($status);

            match ($dataStatus) {
                AchievementStatus::ACTIVE => $this->service->updateStatusData($id, AchievementStatus::ACTIVE),
                AchievementStatus::INACTIVE => $this->service->updateStatusData($id, AchievementStatus::INACTIVE),
                default => null,
            };
    ...
    public function executeBulkAction(): void
    {
        ...
        try {
            match ($this->bulkAction) {
                ...
                'active' => $this->bulkUpdateStatus(AchievementStatus::ACTIVE),
                'inactive' => $this->bulkUpdateStatus(AchievementStatus::INACTIVE),
                default => null,
            };
    ...
    protected function bulkUpdateStatus(AchievementStatus $status): void
    {
