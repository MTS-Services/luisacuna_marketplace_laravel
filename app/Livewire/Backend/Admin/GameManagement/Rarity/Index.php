...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        $actions = [
            [
                'key' => 'id',
                'label' => 'View',
                'route' => 'admin.gm.rarity.show',
                'encrypt' => true
            ],
            [
                'key' => 'id',
                'label' => 'Edit',
                'route' => 'admin.gm.rarity.edit',
                'encrypt' => true
            ],
            [
                'key' => 'id',
    ...
    {
        try {
            $dataStatus = RarityStatus::from($status);

            match ($dataStatus) {
                RarityStatus::ACTIVE => $this->service->updateStatusData($id, RarityStatus::ACTIVE),
                RarityStatus::INACTIVE => $this->service->updateStatusData($id, RarityStatus::INACTIVE),
                default => null,
            };
    ...
    public function executeBulkAction(): void
    {
        ...
        try {
            match ($this->bulkAction) {
                ...
                'active' => $this->bulkUpdateStatus(RarityStatus::ACTIVE),
                'inactive' => $this->bulkUpdateStatus(RarityStatus::INACTIVE),
                default => null,
            };
    ...
    protected function bulkUpdateStatus(RarityStatus $status): void
    {
