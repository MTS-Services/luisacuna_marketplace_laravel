...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        $actions = [
            [
                'key' => 'id',
                'label' => 'View',
                'route' => 'admin.gm.type.show',
                'encrypt' => true
            ],
            [
                'key' => 'id',
                'label' => 'Edit',
                'route' => 'admin.gm.type.edit',
                'encrypt' => true
            ],
            [
                'key' => 'id',
        ...
        return view('livewire.backend.admin.game-management.type.index', [
    ...
    {
        try {
            $dataStatus = TypeStatus::from($status);

            match ($dataStatus) {
                TypeStatus::ACTIVE => $this->service->updateStatusData($id, TypeStatus::ACTIVE),
                TypeStatus::INACTIVE => $this->service->updateStatusData($id, TypeStatus::INACTIVE),
                default => null,
            };
    ...
    public function executeBulkAction(): void
    {
        ...
        try {
            match ($this->bulkAction) {
                ...
                'active' => $this->bulkUpdateStatus(TypeStatus::ACTIVE),
                'inactive' => $this->bulkUpdateStatus(TypeStatus::INACTIVE),
                default => null,
            };
    ...
    protected function bulkUpdateStatus(TypeStatus $status): void
    {
