        ...
        <div class="bg-bg-primary rounded-2xl p-4 shadow-lg transition">
            ...
            <div class="flex justify-between items-start">
                <div class="flex items-center space-x-2">
                    <div class="bg-orange-500 text-white font-bold rounded-md w-6 h-6 flex items-center justify-center">
                        F</div>
                ...
                <div class="flex items-center space-x-1 text-gray-400 text-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 15 15"
                        ...
                        <path
                            ...
                            stroke="#9CA3AF" stroke-width="1.36236" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <span>Instant</span>
                </div>
            </div>

            <div class="border-t border-purple-900 mt-2 pt-3 flex items-center justify-between gap-2">
                ...
                <div class="w-18 h-14 relative">
                    ...
                    <span
                        class="absolute bottom-0 right-0 w-5 h-5 bg-green-500 border-2 border-white rounded-full"></span>
                </div>
