<div class="relative" x-data="notificationBell" x-init="init({{ auth()->guard('admin')->id() }}, 'admins')" @click.away="$wire.showDropdown = false">

    <!-- Same HTML structure as user notification bell -->
    ...
    @if ($showDropdown)
        <div
            ...
            <div class="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-gray-50">
                <h3 class="text-lg font-semibold text-gray-900">Admin Notifications</h3>
                @if ($unreadCount > 0)
                ...
                @empty
                    <div class="px-4 py-12 text-center">
                        <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 10 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" />
                        </svg>
        ...
        Alpine.data('notificationBell', () => ({
            ...
            showBrowserNotification(notification) {
                if ('Notification' in window && Notification.permission === 'granted') {
                    new Notification('[ADMIN] ' + notification.title, {
