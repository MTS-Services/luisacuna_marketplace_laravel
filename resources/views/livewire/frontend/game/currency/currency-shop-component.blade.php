    ...
    <div class="container ">
        ...
        <div class="mb-8 space-y-4">
            <div class="flex gap-4 flex-wrap">
                ...
                <x-ui.select id="delivery-time-select" class="py-0.5! w-auto! rounded-full!">
            ...
            <div class="flex gap-3 justify-end">
                <button class="px-4 py-2 border border-green-500 text-green-500 rounded-full text-sm hover:bg-green-500 hover:text-white transition">
                    ● {{ __('Online Seller') }}
                </button>
    ...
    <a href="{{ route('boost.buy-now') }}" wire:navigate>
        <div class="bg-bg-primary rounded-lg p-8 border border-slate-800 hover:border-purple-400 transition">
            ...
            <div class="flex gap-1 text-sm text-text-secondary py-4">
                <span class="flex items-center gap-1 px-2 py-1 text-white text-text-white bg-slate-800/60 rounded-full text-sm hover:bg-slate-700 transition">
                    <img src="{{ asset('assets/images/light.png') }}" alt="">{{ __('2222Pc') }}
                </span>
            ...
            <div class="border-slate-700 pt-14 flex items-center justify-between py-4">
                ...
                <span class="flex items-center gap-2 px-3 py-1 bg-slate-800/60 text-text-secondary rounded-full text-sm hover:bg-slate-700 transition text-white text-text-white">
            ...
            <div class="border-t border-[#853EFF] pt-4 mt-4 flex items-center gap-3">
                <img src="{{ asset('assets/images/Victoria.png') }}" alt="Victoria" class="w-10 h-10 rounded-full">
                <div>
                    <p class="font-semibold text-text-white">{{ __('Victoria') }}</p>
                    <p class="text-sm text-text-secondary">
                        <img class="inline mr-2" src="{{ asset('assets/images/thumb up filled.png') }}" alt="thumb up">
    ...
    <a href="{{ route('boost.buy-now') }}" wire:navigate>
        <div class="bg-bg-primary rounded-lg p-8 border border-slate-800 hover:border-purple-400 transition">
            ...
            <div class="flex gap-4 text-sm text-slate-400 py-4">
                <span class="flex items-center gap-1 px-3 py-1 bg-slate-800/60 rounded-full text-sm hover:bg-slate-700 transition text-white text-text-white">
            ...
            <div class="border-slate-700 pt-14 flex items-center justify-between py-4">
                ...
                <span class="text-white text-text-white flex items-center gap-1 px-2 py-1 bg-slate-800/60 rounded-full text-sm hover:bg-slate-700 transition">
                    <img src="{{ asset('assets/images/Time Circle.png') }}" alt="img"> {{ __('Instants') }}
                </span>
            </div>
            <div class="border-t border-[#853EFF] pt-4 mt-4 flex items-center gap-3">
                <img src="{{ asset('assets/images/Colleen.png') }}" alt="Colleen" class="w-10 h-10 rounded-full">
                <div>
