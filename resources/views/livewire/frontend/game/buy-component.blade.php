<section>
    <div class="max-w-7xl mx-auto px-8 py-8">
        ...
        <div class="flex items-center gap-2 mb-8 text-md font-semibold">
            ...
            <span class=" text-text-primary">{{__('Buy Now')}}</span>
        </div>
        <div>
...
                                    <p class=" sm:text-sm md:text-md lg:text-lg">{{ __('READ BEFORE PURCHASE ! (ONLY GAMEPASS) 30% Tax IS NOT COVERED') }}</p>
                                </div>
...
                                        </li>
                                        <li><span class="font-semibold">2.</span>{{ __('Make a gamepass and send us the link.') }}</li>
                                        <li><span class="font-semibold">3.</span>{{ __('Robuxwill be Pending for 3-7 days') }}</li>
                                    </ol>
                                </div>

                                                                <div class="space-y-4 text-lg text-gray-400">
                                    <p>{{ __('(By purchasing you agree to the following terms) No refunds after purchasing a game pass We are not responsible for account bans. No refund, no after-sales service. rmt violates the game') }}</p>
                                    <p>{{ __('(By purchasing you agree to the following terms) No refunds after purchasing a game pass We are not responsible for account bans. No refund, no after-sales service. rmt violates the game') }}</p>
                                </div>
                            </div>
			...
			<a href="{{ route('game.buy', ['gameSlug' => $gameSlug, 'categorySlug' => $categorySlug, 'sellerSlug' => 'seller-1']) }}"
				...
				<div class="bg-bg-primary rounded-lg p-8 border border-slate-800 hover:border-purple-500 transition">
					...
					<div class="border-slate-700 pt-14 flex items-center justify-between py-4 ">
						<span class="bg-[#853FF] text-white px-4 py-2 rounded-full font-bold">{{ __('$76.28') }}</span>
						<span
					...
					<div class="border-t border-[#853FF] pt-4 mt-4 flex items-center gap-3">
						...
						<div>
							...
							<p class="text-sm text-text-primary "> <img class="inline mr-2"
										src="{{ asset('assets/images/thumb up filled.png') }}" alt=""> {{ __('99.3% | 2434 reviews | 1642 Sold') }}</p>
						</div>
					</div>
				</div>
			</a>
