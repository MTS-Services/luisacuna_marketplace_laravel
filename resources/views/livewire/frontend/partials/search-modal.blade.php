<div class="hidden xl:flex items-center" x-data="{ globalSearchModal: false }" x-cloak>
    ...
    <div x-show="globalSearchModal" 
        ...
        class="absolute left-0 right-40 top-[calc(100%+0.5rem)] z-50 px-4 max-w-4xl! mx-auto">
