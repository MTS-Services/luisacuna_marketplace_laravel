<header x-data="{ mobileMenuOpen: false, notification: false, dropdown: '' }"
    ...
    <div class="container px-4 py-4 flex items-center justify-between relative" x-data="{ open: @entangle('activeDropdown').defer = ''  }" x-cloak @click.outside="$wire.closeDropdown(); open=''">
