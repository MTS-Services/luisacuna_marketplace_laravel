<div>
    <div class="bg-bg-primary text-text-white font-sans min-h-screen">
        ...
        <div class="max-w-7xl mx-auto py-12 px-6">
            ...
            @if (
                $typeEnum->value === \App\Enums\CmsType::TERMS_CONDITION->value ||
                    $typeEnum->value === \App\Enums\CmsType::REFUND_POLICY->value ||
                    $typeEnum->value === \App\Enums\CmsType::PRIVACY_POLICY->value ||
                    $typeEnum->value === \App\Enums\CmsType::SELLER_PROTECTION->value)
