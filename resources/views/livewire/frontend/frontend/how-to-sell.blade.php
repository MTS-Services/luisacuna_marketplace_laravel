<div>
    ...
    <div class="bg-bg-primary pt-12">
        ...
        <div class="text-center mb-10">
            <h1 class="text-3xl font-semibold mb-2">{{ __('Trade Protect For Buyers') }}</h1>
            <p class="text-text-secondary text-sm">{{ __('Update Time : 2025-09-10 16:41:31') }}</p>
        </div>

        <div class="text-center mb-16">
            <h1 class="text-3xl font-semibold mb-4">{{ __('How to Buy on Digital Commerce!') }}</h1>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute left-1/2 top-0 bottom-0 w-px transform -translate-x-1/2">
                            ...
                            <div
                                class="w-full h-full bg-gradient-to-b from-pink-500 bg-purple-800 bg-blue-400 [mask-image:repeating-linear-gradient(to_bottom,black_0_10px,transparent_10px_20px)]">
                            </div>
                        </div>
