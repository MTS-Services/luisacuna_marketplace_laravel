            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="text-center">
                    ...
                    <p class="text-text-secondary text-sm">
                        {{ __('Our platform uses industry-leading encryption to ensure your
                                                transactions are safe and secure, guaranteeing a safe shopping experience.') }}
                    </p>
                </div>
                ...
                <div class="text-center relative">
                    ...
                    <p class="text-text-secondary text-sm">
                        {{ __('We meticulously verify each seller to ensure you receive
                                                genuine digital goods from trusted sources.') }}
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-white/70 mb-4">
                        {{ __('Digital Commerce is your go-to destination for buying and selling
                                                high-quality digital products. We connect buyers and verified sellers, ensuring secure
                                                transactions, fast delivery, and dedicated support for a seamless experience.') }}
                    </p>
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-bg-primary rounded-xl p-4 cursor-pointer"
                        ...
                        <p x-show="active === 0" x-transition class="mt-2 text-text-secondery text-sm">
                            {{ __('Browse or search for your desired digital product. Click on the product, review the
                                                        details,
                    ...
                    <div class="bg-bg-primary rounded-xl p-4 cursor-pointer"
                        ...
                        <div class="flex justify-between items-center">
                            <h3 class="text-text-white font-semibold">{{__("What if the seller doesn't deliver the product?")}}
                            </h3>
            ...
            <template x-if="tab === 'sellers'">
                <div class="space-y-4">
                    ...
                    <div class="bg-bg-primary rounded-xl p-4 cursor-pointer"
                        ...
                        <p x-show="active === 0" x-transition class="mt-2 text-text-secondery text-sm">
                            {{__('Click "Start Selling" or register an account and navigate to the seller dashboard. You
                            will
                    ...
                    <div class="bg-bg-primary rounded-xl p-4 cursor-pointer"
                        @click="active === 1 ? active = null : active = 1">
                        <div class="flex justify-between items-center">
                            <h3 class="text-text-white font-semibold">{{__('Why do I need to be verified to sell?')}}</h3>
                            <svg :class="active === 1 ? 'rotate-180' : ''"
                                class="w-5 h-5 text-text-white transition-transform" fill="none"
                                stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        ...
                        <p x-show="active === 1" x-transition class="mt-2 text-text-secondery text-sm">
                            {{ __('Verification helps us ensure the authenticity and trustworthiness of sellers on our
                            platform.') }}
                        </p>
                    </div>
                    ...
                    <div class="bg-bg-primary rounded-xl p-4 cursor-pointer"
                        @click="active === 2 ? active = null : active = 2">
                        <div class="flex justify-between items-center">
                            <h3 class="text-text-white font-semibold">{{__('What kind of digital products can I sell?')}}</h3>
                            <svg :class="active === 2 ? 'rotate-180' : ''"
                                class="w-5 h-5 text-text-white transition-transform" fill="none"
                                stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                    ...
                    <div class="bg-bg-primary rounded-xl p-4 cursor-pointer"
                        ...
                        <p x-show="active === 3" x-transition class="mt-2 text-text-secondery text-sm">
                            {{ __('Register your product on the seller dashboard by providing the required details and
                    ...
                    <div class="bg-bg-primary rounded-xl p-4 cursor-pointer"
                        ...
                        <p x-show="active === 4" x-transition class="mt-2 text-text-secondery text-sm">
                            {{__('Payments are processed securely via the platform, and funds are transferred according to
