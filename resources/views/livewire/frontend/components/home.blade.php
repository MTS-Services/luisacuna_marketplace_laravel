<div class="max-w[1950px] mx-auto oiverflow-hidden">
    <div class="bg-black/50 w-full">
        <!-- Hero Section -->
        <section class="max-w-7xl mx-auto relative py-20 overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto relative z-10 text-center">
                ...
                <div class="flex gap-4 justify-center flex-wrap">
                    ...
                    <button class="btn-secondary"><span><x-flux::icon name="shopping-cart" class="w-5 h-5 inline-block"
                                stroke="#853EFF" />
        ...
        <section class="py-20">
            <div class="max-w-7xl px-[100px] mx-auto">
        ...
        <!-- About Us Section -->
        <section class="py-20">
            <div class="max-w-7xl mx-auto py-20 px-[100px] bg-gradient-to-r from-[#5f3fbc]  to-[#50072c]">
        ...
        <!-- FAQ Section -->
        <section class="py-20">
            <div class="max-w-7xl mx-auto py-8 px-[100px] bg-black/50" x-data="{ active: 0, tab: 'buyers' }">

                <h2 class="text-white text-center text-[40px] mb-6 font-semibold">Frequently Asked Questions</h2>

                <!-- Tabs -->
                <div class="max-w-xs mx-auto flex justify-between mb-8 bg-[#1B0C33] rounded-full px-4 py-3">
                    <button @click="tab = 'buyers'; active = 0"
                        :class="tab === 'buyers' ? 'bg-purple-700 px-5 py-2 rounded-full shadow-lg text-white' : 'text-gray-300 px-7'"
                        class="transition-colors duration-300 font-medium">
                        For Buyers
                    </button>
                    <button @click="tab = 'sellers'; active = 0"
                        :class="tab === 'sellers' ? 'bg-purple-700 px-5 py-2 rounded-full shadow-lg text-white' : 'text-gray-300 px-7'"
                        class="transition-colors duration-300 font-medium">
                        For Sellers
                    </button>
                </div>
                ...
                <template x-if="tab === 'buyers'">
                    <div class="space-y-4">
                        ...
                        <!-- Buyer FAQ Items -->
                        <div class="bg-[#2a1f4c] rounded-xl p-4 cursor-pointer"
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <svg :class="active === 0 ? 'rotate-180' : ''"
                                    class="w-5 h-5 text-white transition-transform" fill="none"
