         ...
         <div class="w-full max-w-6xl ">
             ...
             <div class=" bg-bg-primary rounded-2xl p-18 shadow-2xl">
                 ...
                 <div class="mb-8">
                     ...
                     <!-- Input Field -->
                     <textarea placeholder="Type here......" maxlength="300" class="w-full bg-bg-secondary  border-purple-500/30 rounded-xl p-4 dark:placeholder-white placeholder-opacity-100 focus:outline-none focus:border-purple-400/60 focus:ring-2 focus:ring-purple-500/20 transition-all resize-none h-24 text-xl" spellcheck="false" aria-label="To enrich screen reader interactions, please activate Accessibility in Grammarly extension settings"></textarea>
                 </div>
     ...
     <div class="  p-8 ">
         <div class="bg-bg-primary max-w-6xl mx-auto rounded-2xl">
             ...
             <div class="bg-bg-primary backdrop-blur-sm rounded-2xl p-8 mb-0  ">
                 <h2 class="text-3xl font-light text-text-white mb-6 pb-4 border-b border-purple-500/50">Quantity</h2>
             ...
             <div class="bg-bg-primary rounded-2xl p-12  ">
                 ...
                 <!-- Helper Text -->
                 <p class="text-text-white text-sm">Competitive prices improve your offer's ranking in the offer list.
                 </p>
             </div>
         </div>
     </div>
