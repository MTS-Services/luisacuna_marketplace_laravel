<section>
    <div class="container">
        ...
        <div class="item ">
                ...
                <div class="item-short-info flex justify-between">
                    ...
                    <div class="button">
                        <x-ui.button :variant="'tertiary'"
                            class="!bg-btn-danger !border-none hover:!text-primary-50 ">Cancel Order</x-ui.button>
                    </div>
            ...
            <div class="item-details pb-10">
                <div class="flex gap-6 ">
                    <div class="details-left w-2/3 p-10 bg-bg-base rounded-3xl">
                        <div class="flex items-center pb-5">
                            <div class="w-16.5 h-16.5 flex items-center justify-center bg-white/6 rounded-full ">
                    ...
                    <div class="detail-right w-1/3 p-7 bg-bg-base rounded-3xl">
                        <div class="pb-6">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between pb-3">
                                ...
                                <p class="flex flex-end">
                                    <span class="text-base pl-3 text-bg-tertiary">D18QUAN</span>
                                    <span class="text-base pl-3">
                                        <flux:icon icon="check" class="inline-block pl-3 "></flux:icon>
                                        Online
                                    </span>
                                </p>
                            </div>
                        ...
                        <div class="pt-10">
                            <x-ui.button :variant="'primary'" class="!bg-btn-primary !border-none hover:!text-primary-50">
        ...
        <div class="chat mt-10 mb-16 px-20 py-10 bg-white/10 rounded-3xl">
            <div class="mb-10">
                <div class="py-7 px-7 rounded-3xl bg-bg-base flex flex-row border-l-3 border-pink-500">
        ...
        <div class="secruity-tips pb-25">
            <div class="w-full mb-10">
                <div class="py-7 px-7 rounded-3xl bg-bg-base flex flex-col w-full">
                    <div class="flex flex-col w-full ">
