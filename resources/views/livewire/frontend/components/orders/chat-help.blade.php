                    ...
                    <div class="detail-right w-full p-7 bg-zinc-50 dark:bg-bg-light  rounded-3xl">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between pb-3">
                                ...
                                <p class="flex flex-end">
                                    <span class="text-base pl-3"> 1 Days </span>
                                </p>
                            </div>
                            <div class="flex justify-between pb-3">
                                <p class="text-base">Delivery Method</p>
                                <p class="flex flex-end">
                                    <span class="text-base pl-3"> in-game Delivery </span>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="payment-info w-full p-20 bg-bg-light  rounded-3xl  mb-25">
                ...
                <div class="w-full ">
                    ...
                    <div class="flex justify-between pb-3">
                        ...
                        <p class="flex flex-end">
                            <span class="text-base pl-3"> $ <span> {{ __('1.20') }}</span></span>
                        </p>
                    </div>
                    <div class="flex justify-between pb-3">
                        <p class="text-base">Payment Fee </p>
                        <p class="flex flex-end">
                            <span class="text-base pl-3">0.00</span>
                        </p>
                    </div>
                    <div class="flex justify-between pb-3">
                        <p class="text-base">Quantity</p>
