    ...
    <div class="max-w-4xl mx-auto py-8">
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="p-6 md:p-8 bg-gradient-to-r from-blue-600 to-blue-700">
                <h2 class="text-2xl md:text-3xl font-bold text-white">Two-Factor Authentication</h2>
                <p class="text-blue-100 mt-2 text-sm md:text-base">Secure your account with additional protection</p>
            </div>
            ...
            <div class="p-6 md:p-8">
                ...
                @if (!$twoFactorEnabled)
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        <h3 class="text-xl font-bold mb-4 text-gray-900 dark:text-white">Enable Two-Factor
                            Authentication</h3>
                ...
                @else
                    ...
                    @if (!auth()->user()->two_factor_confirmed_at)
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-6 mb-8">
                            <h3 class="text-xl font-bold mb-4 text-gray-900 dark:text-white">Finish Enabling Two-Factor
                                Authentication</h3>
                    ...
                    @if (auth()->user()->two_factor_confirmed_at)
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-6 mb-8">
                            <h3 class="text-xl font-bold mb-4 text-gray-900 dark:text-white">Recovery Codes</h3>
                            <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                            ...
                            <div id="recoveryCodes" class="hidden mb-4">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-3 flex items-start">
                                    ...
                                    <span>Save these codes in a safe place. Each code can only be used once.</span>
                                </p>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        @if (auth()->user()->two_factor_confirmed_at)
                            <h3 class="text-xl font-bold mb-4 text-red-600 dark:text-red-400">Disable Two-Factor
                                Authentication</h3>
                            <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                                ...
                                <span class="ml-7 block">Disabling two-factor authentication will make your account
                        ...
                        @else
                            <h3 class="text-xl font-bold mb-4 text-red-600 dark:text-red-400">Cancel Processing</h3>
                            <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                                <span class="inline-flex items-center">
                                    <span class="text-lg mr-2">⚠️</span>
                                    <strong>Warning:</strong>
                                </span>
                                <span class="ml-7 block">Cancel two-factor authentication processing will make your
