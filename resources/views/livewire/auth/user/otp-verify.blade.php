        ...
        <div class="w-full  max-w-lg bg-gradient-to-br bg-bg-primary rounded-2xl  px-8 py-22 shadow-2xl ">
            ...
            <form wire:submit="verifyOtp" class="space-y-6">
                ...
                <div>
                    ...
                    <x-ui.input-error :messages="$errors->get('otp')" />
                </div>
                <div class="text-right">
                    <span wire:navigate wire:click.prevent="resendOtp"  class="text-text-white transition cursor-pointer">{{ __('Don’t have resend again?') }}</span>
                </div>
