<div class="bg-cover bg-center bg-page-login">
    ...
    <div class="min-h-[100vh] flex items-center justify-center text-white px-4  sm:px-6 lg:px-8 ">
        <form method="POST" wire:submit="verifyOtp" class="w-full max-w-md sm:max-w-lg md:max-w-xl">
            <div
                class="bg-zinc-900/40 dark:bg-bg-secondary/75 backdrop-blur-sm dark:backdrop-blur-sm rounded-2xl p-8 shadow-lg flex flex-col justify-between min-h-[75vh]">
                ...
                <div>
                    ...
                    @else
                        ...
                        <form wire:submit="verifyOtp" class="space-y-6">
                            ...
                            <div class=" flex justify-center px-2 sm:px-6 mt-4">
                ...
                <!-- Divider -->
                <div class="flex items-center mb-4 mt-4 px-4">
                ...
                <div>
                    ...
                    <!-- Sign up link -->
                    <div class="text-center text-sm xs:text-base font-normal text-white mb-4">
