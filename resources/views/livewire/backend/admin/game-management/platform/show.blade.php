<div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-xl p-6 min-h-[500px]">
        <h3 class="text-2xl font-bold mb-1 text-gray-900 dark:text-white mb-4">
            {{ __('Platform Details') }}</h3>


        <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">

            <div class="col-span-1">
                <p class="text-gray-500 dark:text-gray-400">{{__('Platform Name')}}</p>
                <p class="font-mono font-semibold text-gray-900 dark:text-white uppercase">{{ $data->name }}</p>
            </div>
