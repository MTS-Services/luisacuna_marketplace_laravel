<section>
    ...
    <div class="glass-card rounded-2xl p-6 mb-6">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-text-black dark:text-text-white">{{ __('Type Create') }}</h2>
        ...
        <form wire:submit="save">
            ...
            <div class="mt-6 space-y-4 grid grid-cols-2 gap-5">
                ...
                <div class="w-full">
                    ...
                    <x-ui.input type="text" placeholder="Sort Order" id="sort_order" wire:model="form.sort_order" />
