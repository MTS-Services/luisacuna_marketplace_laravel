<section>
    ...
    <x-ui.confirmation-modal :show="'showDeleteModal'" :title="'Delete this Category?'" :message="$deleteWarningMessage ?? 'Are you absolutely sure you want to remove this Category? All associated data will be permanently deleted.'" :method="'delete'"
