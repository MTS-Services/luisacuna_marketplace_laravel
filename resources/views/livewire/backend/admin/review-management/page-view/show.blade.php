    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-xl p-6 min-h-[500px]">
        ...
        @if($data->viewable)
            <div class="mt-6 border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 rounded-lg p-4 border border-blue-200 dark:border-gray-700">
        ...
        @if($data->viewer)
            <div class="mt-6 border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <div class="bg-gradient-to-br from-green-50 to-teal-50 dark:from-gray-900 dark:to-gray-800 rounded-lg p-4 border border-green-200 dark:border-gray-700">
