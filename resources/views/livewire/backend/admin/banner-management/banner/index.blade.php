<section>
    ...
    <x-ui.confirmation-modal :show="'showDeleteModal'" :title="'Delete this Data?'" :message="'Are you absolutely sure  want to remove this data? All associated data will be moved to trash.'" :method="'delete'"
