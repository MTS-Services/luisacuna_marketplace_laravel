<section>
    <div class="glass-card rounded-2xl p-6 mb-6">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-text-black dark:text-text-white">{{ __('Banner Create') }}</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-5">
                        ...
                        <div>
                            ...
                            <x-ui.input type="text" wire:model="form.title" placeholder="{{ __('Title Here') }}"
                                class="mt-2 placeholder:text-text-primary" />
                        ...
                        <div>
                            ...
                            <x-ui.textarea wire:model="form.content" placeholder="{{ __('Description here') }}"
                                class="mt-2 placeholder:text-text-primary!" rows="4" />
