                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div class="bg-slate-50 dark:bg-gray-700 rounded-lg p-4 border border-slate-200">
                                ...
                                @if ($data->game && $data->game->logo)
                                    <img src="{{ storage_url($data->game->logo) ?? 'N/A' }}" alt=""
                            ...
                            <div class="bg-slate-50 dark:bg-gray-700 rounded-lg p-4 border border-slate-200">
                                ...
                                <p class="text-slate-400 text-lg font-bold"></p>{{ $data->game->name ?? 'N/A' }}</p>
                            </div>
                            <div class="bg-slate-50 dark:bg-gray-700 rounded-lg p-4 border border-slate-200">
                            ...
                            <div class="bg-slate-50 dark:bg-gray-700 rounded-lg p-4 border border-slate-200">
                                ...
                                <p class="text-slate-400 text-lg font-bold"></p>{{ $data->quantity ?? 'N/A' }}</p>
                            </div>
                            <div class="bg-slate-50 dark:bg-gray-700 rounded-lg p-4 border border-slate-200">
                                <p class="text-text-white text-xs font-semibold mb-2">{{ __('Platform') }}</p>

                                <p class="text-slate-400 text-lg font-bold"></p>{{ $data->platform->name ?? 'N/A' }}
                                </p>
                            </div>
                            <div class="bg-slate-50 dark:bg-gray-700 rounded-lg p-4 border border-slate-200">
                            ...
                            <div class="bg-slate-50 dark:bg-gray-700 rounded-lg p-4 border border-slate-200">
                                ...
                                <p class="text-lg font-bold badge badge-soft {{ $data->status->color() }}">{{ $data->status->label() }}</p>
                            </div>
