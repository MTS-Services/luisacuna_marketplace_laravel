        ...
        <form wire:submit="save" enctype="multipart/form-data">
            <div class="mt-6 space-y-4 grid grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <x-ui.input id="release_date" type="date" class="mt-1 block w-full"
                        wire:model="form.release_date" placeholder="release date" />
                ...
                <div>
                    ...
                    <div class="flex flex-nowrap gap-3">
                        @foreach ($platforms as $platform)
                            <div>
                                <input type="checkbox" name="" id="checkbox{{ $platform['id'] }}"
                                    wire:model="form.platform" value="{{ $platform['id'] }}">
                ...
                <div class="col-span-2">
                    ...
                    <x-ui.input id="meta_keywords" type="text" class="mt-1 block w-full"
                        wire:model="form.meta_keywords" placeholder="Meta Keywords" />
