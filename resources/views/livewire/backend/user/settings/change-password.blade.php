        ...
        <div class="fixed inset-0 dark:bg-bg-primary bg-black/50 flex items-center justify-center z-50"
            ...
            <div class="dark:bg-bg-secondary bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl"
                ...
                <div class="space-y-6">
                    ...
                    <!-- Old Password -->
                    <div class="w-full">
                        <x-ui.label value="Old password:" class="text-base! font-semibold! mb-3! text-text-white!" />
                        <x-ui.input type="password" placeholder="Enter old password" wire:model="form.password_old" />
                        <x-ui.input-error :messages="$errors->get('form.password_old')" />
                    </div>

                    <!-- New Password -->
                    <div class="w-full">
                        <x-ui.label value="New password:" class="text-base! font-semibold! mb-3! text-text-white!" />
                        <x-ui.input type="password" placeholder="Enter new password" 
                    ...
                    <div x-show="touched" x-transition>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <x-phosphor name="check" variant="regular" class="w-4 h-4 text-zinc-500" x-show="hasLowercase" x-cloak />
                        ...
                        <div class="flex items-center gap-2 mt-2">
                            ...
                            <x-phosphor name="check" variant="regular" class="w-4 h-4 text-zinc-500" x-show="hasUppercase" x-cloak />
                        ...
                        <div class="flex items-center gap-2 mt-2">
                            ...
                            <x-phosphor name="check" variant="regular" class="w-4 h-4 text-zinc-500" x-show="hasNumber" x-cloak />
                        ...
                        <div class="flex items-center gap-2 mt-2">
                            ...
                            <x-phosphor name="check" variant="regular" class="w-4 h-4 text-zinc-500" x-show="hasMinLength" x-cloak />
                        ...
                        <div class="flex items-center gap-2 mt-2">
                            ...
                            <x-phosphor name="check" variant="regular" class="w-4 h-4 text-zinc-500" x-show="noSpaces" x-cloak />
                    ...
                    <!-- Confirm Password -->
                    <div class="w-full">
                        <x-ui.label value="Re-enter new password:" class="text-base! font-semibold! mb-3! text-text-white!" />
                        <x-ui.input type="password" placeholder="Re-enter new password" wire:model="form.password_confirmation" />
