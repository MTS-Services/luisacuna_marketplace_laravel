        ...
        <div class="mb-6">
            ...
            <div class="flex gap-2 xxs:gap-3 sm:gap-6 items-start">
                <a wire:navigate
                    ...
                    <div
                        class="w-[50px] h-[50px] xxs:w-[60px] xxs:h-[60px] sm:w-[80px] sm:h-[80px] mb-2 {{ $activeTab === 'currency' ? 'bg-zinc-500' : 'bg-zinc-800' }}  rounded-full flex items-center justify-center">
                        <img src="{{ asset('assets/images/user_profile/Vector.png') }}" alt="Currency Icon"
                            class="w-[20px] h-[20px] sm:w-[40px] sm:h-[40px] object-contain">
                    </div>


                    <h3 class="text-xl hidden sm:block font-medium whitespace-nowrap">{{ __('Currency (0)') }}</h3>
                </a>
                ...
                <a wire:navigate
                    ...
                    class="flex flex-col items-center">
                    <div
                        class="w-[50px] h-[50px] xxs:w-[60px] xxs:h-[60px] sm:w-[80px] sm:h-[80px] mb-2 {{ $activeTab === 'account' ? 'bg-zinc-500' : 'bg-zinc-800' }} rounded-full flex items-center justify-center">
                        <img src="{{ asset('assets/images/user_profile/download (4) 1.png') }}" alt="Account Icon"
                            class="w-[30px] h-[30px] sm:w-[40px] sm:h-[40px] object-contain">
                    </div>
                    <h3 class="text-xl hidden sm:block font-medium whitespace-nowrap">{{ __('Account (0)') }}</h3>
                </a>

                <a wire:navigate href="{{ route('profile', ['username' => $user->username, 'activeTab' => 'items']) }}"
                    class="flex flex-col items-center">
                    <div
                        class="w-[50px] h-[50px] xxs:w-[60px] xxs:h-[60px] sm:w-[80px] sm:h-[80px] mb-2 {{ $activeTab === 'items' ? 'bg-zinc-500' : 'bg-zinc-800' }} rounded-full flex items-center justify-center">
                        <img src="{{ asset('assets/images/user_profile/download 1.png') }}" alt="Items Icon"
                            class="w-[30px] h-[30px] sm:w-[40px] sm:h-[40px] object-contain">
                    </div>
                    <h3 class="text-xl hidden sm:block font-medium whitespace-nowrap">{{ __('Items (0)') }}</h3>
                </a>
                ...
                <a wire:navigate
                    ...
                    class="flex flex-col items-center">
                    <div
                        class="w-[50px] h-[50px] xxs:w-[60px] xxs:h-[60px] sm:w-[80px] sm:h-[80px] mb-2 {{ $activeTab === 'topups' ? 'bg-zinc-500' : 'bg-zinc-800' }} rounded-full flex items-center justify-center">
                        <img src="{{ asset('assets/images/user_profile/download (2) 1.png') }}" alt="Top Ups Icon"
                            class="w-[30px] h-[30px] sm:w-[40px] sm:h-[40px] object-contain">
                    </div>
                    <h3 class="text-xl hidden sm:block font-medium whitespace-nowrap">{{ __('Top Ups (0)') }}</h3>
                </a>
                ...
                <a wire:navigate
                    ...
                    class="flex flex-col items-center">
                    <div
                        class="w-[50px] h-[50px] xxs:w-[60px] xxs:h-[60px] sm:w-[80px] sm:h-[80px] mb-2 {{ $activeTab === 'giftcards' ? 'bg-zinc-500' : 'bg-zinc-800' }} rounded-full flex items-center justify-center">
                        <img src="{{ asset('assets/images/user_profile/download (1) 1.png') }}" alt="Gift Cards Icon"
                            class="w-[30px] h-[30px] sm:w-[40px] sm:h-[40px] object-contain">
                    </div>
                    <h3 class="text-xl hidden sm:block font-medium whitespace-nowrap">{{ __('Gift Cards (0)') }}</h3>
                </a>
            </div>
