<div x-data="{ show: false }" x-on:open-modal.window="if ($event.detail === 'download-invoice-modal') show = true"
    ...
    x-on:keydown.escape.window="show = false" x-show="show" class="fixed inset-0 z-[9999] overflow-y-auto"
    style="display: none;">

    <!-- Backdrop -->
    <div class="fixed inset-0 bg-black/20 backdrop-blur-sm transition-opacity z-[9998]" x-show="show"
    ...
    <div class="flex min-h-screen items-center justify-center p-4 relative z-[9999]">
        <div class="relative bg-bg-primary rounded-lg shadow-xl w-full max-w-md" x-show="show"
            ...
            <div class="px-6 pb-6 space-y-4">
                ...
                <div class="relative w-full">
                    ...
                    <x-ui.custom-select wire:model.live="selectedMonth" class="rounded!">
                ...
                <div class="relative w-full">
                    ...
                    <x-ui.custom-select wire:model.live="fileType" class="rounded!">
