<main class="mx-auto">
    <section class="container mx-auto">
        ...
        <div class="flex items-center gap-1 my-10 font-semibold">
            ...
            <div class="block sm:flex gap-6 justify-between items-start mt-10 mb-20">
                <div class="w-full sm:w-2/3">
                    <div class=" bg-zinc-900 p-10 rounded-lg">
                        <div class="flex gap-4 items-center">
                            <div class="bg-zinc-950 rounded-full p-3">
                ...
                <div class="w-full sm:w-1/3 bg-zinc-900 p-7 rounded-lg">
                    <div class="flex gap-4 items-center">
                        <h3 class="text-text-white text-2xl font-semibold">{{ __('Order cancelled') }}</h3>
                    </div>
                    <div class="">
        ...
        <div class="bg-zinc-900/80 rounded-lg mt-20 5 sm:p-20">

            <!-- User Header -->
            <div class="bg-zinc-950 rounded-lg p-5 border-l-4 border-pink-500 mb-10">
            ...
            <div class="bg-zinc-950 rounded-lg p-5 border-l-4 border-pink-500 mt-10">
                <div>
                    <p class="text-text-white text-base mb-2">{{ __('Order Disputed by Buyer:') }}</p>
                    <div class="flex items-center gap-2 text-primary-400 text-sm mb-1">
                        <span class="text-text-white">{{ __('Reason: I don\'t want it anymore') }}</span>
        ...
        <div class="bg-zinc-900/80 rounded-lg mt-20 mb-29 py-20 px-10">
            <div class="flex items-center gap-3">
                <div class="w-16 h-16">
