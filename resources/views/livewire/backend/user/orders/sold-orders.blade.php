<div class="space-y-6">
    ...
    <div x-data="{ show: false }" x-on:open-modal.window="if ($event.detail === 'download-invoice-modal') show = true"
        ...
        <!-- Backdrop -->
        <div class="fixed inset-0 bg-bg-primary/50 transition-opacity" x-show="show"
        ...
        <div class="flex min-h-screen items-center justify-center p-4">
            <div class="relative bg-bg-secondary rounded-lg shadow-xl w-full max-w-md" x-show="show"
