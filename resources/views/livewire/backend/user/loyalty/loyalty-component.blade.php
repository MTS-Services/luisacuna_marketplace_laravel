<div class="min-h-screen py-8 px-4">
    <div class="">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            {{-- Bronze Level Card --}}
            <div class="bg-zinc-800  rounded-2xl p-6 border border-primary-700/30">
                ...
                <div class="flex justify-center  mb-6">
                    <div class="relative">
                        <div
                            class="w-26 h-26 rounded-full flex items-center justify-center shadow-lg">
                           <img src="{{ asset('assets/images/loyalty_card.png')}}" alt="" class="w-full h-full">
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center mb-4">
                    ...
                    <div class="text-text-pink text-sm">500/2400</div>
                ...
                <p class="text-text-pink text-center text-sm">
            ...
            <div
                class=" rounded-2xl p-6 border border-pink-700/30 bg-pink-900">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-text-primary font-open-sans text-lg">Available points</h3>
                    <div class="flex items-center gap-2 bg-pink-800/50 px-3 py-1.5 rounded-lg">
                        <x-phosphor-coin class="text-pink-400 w-5 h-5" weight="fill" />
                        <span class="text-white font-semibold">500</span>
                    </div>
                </div>

                <p class="text-text-pink text-sm mb-6">
                ...
                <div class="bg-primary-900/50 rounded-xl p-4 flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-text-pink text-sm">$1 Store credit</div>
                    </div>
                    <button
        ...
        <div class="mb-8">
            <div class="flex items-center gap-3 mb-2">
                <x-phosphor-trophy class="text-pink-500 w-8 h-8" weight="fill" />
                <h2 class="text-white font-open-sans text-2xl font-bold">Achievements completed</h2>
            </div>
            <p class="text-text-pink text-sm ml-11">0 / 10 completed</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="glass-card rounded-2xl p-6 border border-primary-700/30">
                <div class="flex items-start gap-4 mb-4">
                    <div class="w-12 h-12 rounded-xl bg-primary-800/50 flex items-center justify-center flex-shrink-0">
                        <x-phosphor-pencil-line class="text-pink-500 w-6 h-6" weight="fill" />
                    </div>
                    <div class="flex-1">
                        <h4 class="text-white font-semibold text-lg mb-1">Critic</h4>
                        <p class="text-text-pink text-sm">Write reviews for sellers</p>
                    </div>
                </div>
                <div class="flex items-center justify-between text-sm mb-2">
                    <span class="text-text-pink">0 / 1 To unlock</span>
                    <div class="flex items-center gap-1">
                        <x-phosphor-coin class="text-pink-500 w-4 h-4" weight="fill" />
                        <span class="text-pink-500 font-semibold">+500</span>
                    </div>
                </div>
            ...
            <div class="glass-card rounded-2xl p-6 border border-primary-700/30">
                <div class="flex items-start gap-4 mb-4">
                    <div class="w-12 h-12 rounded-xl bg-primary-800/50 flex items-center justify-center flex-shrink-0">
                        <x-phosphor-compass class="text-pink-500 w-6 h-6" weight="fill" />
                    </div>
                    <div class="flex-1">
                        <h4 class="text-white font-semibold text-lg mb-1">Explorer</h4>
                        <p class="text-text-pink text-sm">Place your first order in each category</p>
                    </div>
                </div>
                <div class="flex items-center justify-between text-sm mb-2">
                    <span class="text-text-pink">0 / 1 To unlock</span>
            ...
            <div class="glass-card rounded-2xl p-6 border border-primary-700/30">
                <div class="flex items-start gap-4 mb-4">
                    <div class="w-12 h-12 rounded-xl bg-primary-800/50 flex items-center justify-center flex-shrink-0">
                        <x-phosphor-lightning class="text-pink-500 w-6 h-6" weight="fill" />
                    </div>
                    <div class="flex-1">
                        <h4 class="text-white font-semibold text-lg mb-1">Speedrunner</h4>
                        <p class="text-text-pink text-sm">Place 3 orders in one month</p>
                    </div>
                </div>
                <div class="flex items-center justify-between text-sm mb-2">
                    <span class="text-text-pink">0 / 1 To unlock</span>
            ...
            <div class="glass-card rounded-2xl p-6 border border-primary-700/30">
                <div class="flex items-start gap-4 mb-4">
                    <div class="w-12 h-12 rounded-xl bg-primary-800/50 flex items-center justify-center flex-shrink-0">
                        <x-phosphor-chart-line-up class="text-pink-500 w-6 h-6" weight="fill" />
                    </div>
                    <div class="flex-1">
                        <h4 class="text-white font-semibold text-lg mb-1">Master Trader</h4>
                        <p class="text-text-pink text-sm">Place 2 Escudo orders</p>
                    </div>
                </div>
                <div class="flex items-center justify-between text-sm mb-2">
                    <span class="text-text-pink">0 / 1 To unlock</span>
        ...
        <div class="mb-8">
            <div class="flex items-center gap-3 mb-2">
                <x-phosphor-heart class="text-pink-500 w-8 h-8" weight="fill" />
                <h2 class="text-white font-open-sans text-2xl font-bold">Dedication</h2>
            </div>
            <p class="text-text-pink text-sm ml-11">Purchase at least 2 products per game to earn points</p>
        </div>

        {{-- CTA Card --}}
        <div
            class="glass-card rounded-2xl p-8 border border-pink-700/30 bg-gradient-to-br from-pink-900/40 to-pink-950/40 text-center">
            <div class="flex justify-center mb-4">
                <x-phosphor-gift class="text-pink-500 w-16 h-16" weight="fill" />
            </div>
            <h2 class="text-white font-open-sans text-3xl font-bold mb-4">
                Start Your Reward Journey Today
            </h2>
            <p class="text-text-pink max-w-2xl mx-auto mb-6">
