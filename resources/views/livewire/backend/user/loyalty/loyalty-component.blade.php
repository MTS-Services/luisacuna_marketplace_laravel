    ...
    <div class="">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-bg-primary  rounded-2xl p-6 border border-primary-700/30">
                ...
                <div class="text-center mb-4">
                    <h4 class="text-text-white font-semibold text-xl mb-2">Bronze</h4>
            ...
            <div class="rounded-3xl p-8 bg-pink-200 dark:bg-pink-900">
                <div class="mb-6">
                    <h3 class="text-text-white font-semibold text-xl mb-4">Available points</h3>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <div class="text-text-white font-bold text-2xl mb-1">10,000 points</div>
                        <div class="text-text-white/70 text-sm">$1 Store credit</div>
                    </div>
        ...
        <div class="mb-8">
            <div class="flex items-center gap-3 mb-2">
                <h2 class="text-text-white font-open-sans text-2xl font-bold">Achievements completed</h2>
            </div>
            <p class="text-text-white text-sm ">0 / 10 completed</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="glass-card rounded-2xl p-6 border border-primary-700/30">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div class="flex-1">
                        <h4 class="text-text-white font-semibold font-lato text-lg sm:text-3xl mb-1">Critic</h4>
                        <p class="text-text-white text-sm sm:text-base">Write reviews for sellers</p>
                    </div>
                </div>
                <div class="flex items-center justify-between text-sm mb-2">
                    <span class="text-text-white text-base sm:text-xl">0 / 1 To unlock</span>
            ...
            <div class="glass-card rounded-2xl p-6 border border-primary-700/30">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div class="flex-1">
                        <h4 class="text-text-white font-semibold font-lato text-lg sm:text-3xl mb-1">Explorer</h4>
                        <p class="text-text-white text-sm sm:text-base">Place your first order in each category</p>
                    </div>
                </div>
                <div class="flex items-center justify-between text-sm mb-2">
                    <span class="text-text-white text-base sm:text-xl">0 / 1 To unlock</span>
            ...
            <div class="glass-card rounded-2xl p-6 border border-primary-700/30">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div class="flex-1">
                        <h4 class="text-text-white font-semibold font-lato text-lg sm:text-3xl mb-1">Speedrunner</h4>
                        <p class="text-text-white text-sm sm:text-base">Place 2 orders in one month</p>
                    </div>
                </div>
                <div class="flex items-center justify-between text-sm mb-2">
                    <span class="text-text-white text-base sm:text-xl">0 / 1 To unlock</span>
            ...
            <div class="glass-card rounded-2xl p-6 border border-primary-700/30">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div class="flex-1">
                        <h4 class="text-text-white font-semibold font-lato text-lg sm:text-3xl mb-1">Master Trader</h4>
                        <p class="text-text-white text-sm sm:text-base">Place 2 Eldorado orders</p>
                    </div>
                </div>
                <div class="flex items-center justify-between text-sm mb-2">
                    <span class="text-text-white text-base sm:text-xl">0 / 1 To unlock</span>
        ...
        <div class="mb-8">
            <div class="flex items-center gap-3 mb-2">
                <h2 class="text-text-white font-open-sans text-2xl font-bold">Dedication</h2>
            </div>
            <p class="text-text-white text-sm">Purchase at least 2 products per game to earn points</p>
        </div>
