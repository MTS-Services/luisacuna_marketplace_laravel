        ...
        <div class="bg-bg-primary rounded-lg p-6 mb-6 ">
            ...
            <div class="p-4 rounded-lg max-w-xl mx-auto">
                <div class="flex items-center gap-4">
                    <x-ui.button class="w-auto! py-1! px-3!" x-on:click.prevent="quantity = Math.max(1, quantity - 1)">
        ...
        <div class="flex items-start gap-3">
            ...
            <div class="flex">
                ...
                <div class="flex gap-0 ">
                    ...
                    <span class="text-xs   px-2  rounded"> <img src="{{ asset('assets/images/ApplePay-Light 1.svg') }}"
                            alt="">
                    </span>
                </div>
            </div>
...
<div class="bg-bg-primary rounded-lg  mb-6 px-4 py-4 ">
    ...
    <button class="text-purple-400 hover:text-purple-300 text-sm mt-4 mb-4 font-semibold">{{ __('See ll') }}</button>
    <!-- Seller Card -->
