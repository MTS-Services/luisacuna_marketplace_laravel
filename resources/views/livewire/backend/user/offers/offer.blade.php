    ...
    <div class="container pb-75">
        ...
        <div class="w-full mx-auto p-4 sm:p-10 md:p-20 rounded-2xl ">
            ...
            @if ($step === 1)
                ...
                <h2 class="text-base sm:text-2xl text-center text-text-white mb-4 sm:mb-10">{{ __('Choose category') }}
                </h2>
            ...
            @if ($step === 3)
                ...
                <form wire:submit.prevent="submitOffer">
                    ...
                    <div class="bg-bg-secondary rounded-2xl mb-10 p-4 sm:p-10 md:p-20">
                        <h2 class="text-text-white font-semibold text-2xl sm:text-40px mb-4 sm:mb-10">
                            {{ __('Your item') }}
                        </h2>
                    ...
                    <div class="bg-bg-secondary rounded-2xl mb-10 p-4 sm:p-10 md:p-20">
                        ...
                        <h3 class="text-text-white text-lg sm:text-xl font-medium mb-6">
                            {{ __('Select delivery Timeline') }}
                        </h3>

                        <div class="space-y-4">
                            <x-ui.custom-select label="Delivery Timeline" :options="$timelineOptions"
                    ...
                    <div class="bg-bg-secondary rounded-2xl mb-10 p-4 sm:p-10 md:p-20">
                        <h2 class="text-2xl font-semibold text-text-white mb-2 sm:mb-7">{{ __('Game Title') }}
                        </h2>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-1 gap-3 justify-center mx-auto">
                            <div>
                                ...
                                <x-ui.input type="text" placeholder="Game Title" id="name" wire:model="name"
                    ...
                    <div class="bg-bg-secondary rounded-2xl mb-10 p-4 sm:p-10 md:p-20">
                        <h2 class="text-text-white font-semibold text-2xl sm:text-3xl mb-10">{{ __('Quantity') }}
                        </h2>
                        <!-- Quantity Section -->
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <x-ui.custom-select :label="'Platform'" :options="$platforms" :wireModel="'platform_id'"
                                    mdWidth="md:w-full" rounded="rounded" mdLeft="md:left-0" />
                    ...
                    {{-- <div class="bg-bg-secondary rounded-2xl mb-10 p-4 sm:p-10 md:p-20">
                        <h2 class="text-text-white font-semibold text-2xl sm:text-3xl">{{ __('Delivery method') }}
                        </h2>
