<header class="bg-gray-950 px-6 py-4 z-10">
    <div class="flex items-center justify-between">
        <div class="flex items-center justify-between px-6 py-4  border-gray-800">
            <div>
                <a href="{{ route('user.dashboard') }}" wire:navigate
                    class="text-2xl font-bold bg-gradient-to-r from-purple-500 to-pink-500  text-transparent">
                ...
                <div class="relative hidden sm:block">
                   <flux:icon name="magnifying-glass" class="w-4 h-4 absolute left-3 top-1/2 transform -translate-y-1/2 text-white"
                    ...
                    <input type="text" placeholder="search"
                        class="border border-white rounded-full py-1.5 pl-10 pr-4 text-sm text-white placeholder-gray-100 focus:outline-none focus:border-purple-500 focus:bg-gray-800 transition-all w-24 focus:w-64">
                </div>
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center ">
                <button class="text-white hover:text-white hover:bg-gray-800 rounded transition-all">
                    <img src="{{ asset('assets/icons/MessengerLogo.svg') }}" alt="">
                </button>
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open"
                        ...
                        <div
                            class="w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-sm font-semibold text-white">
                            <img src="{{ storage_url(auth()->user()->avatar) }}" class="w-full h-full rounded-full" alt="">
                        </div>
                    </button>
