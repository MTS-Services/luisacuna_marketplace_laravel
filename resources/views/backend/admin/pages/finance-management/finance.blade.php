<x-admin::app>
    <x-slot name="pageSlug">finance-management</x-slot>
    @switch(Route::currentRouteName())
        @case('admin.finance.withdrawals')
            <x-slot name="pageSlug">withdrawals</x-slot>
        ...
        @case('admin.finance.purchased')
            <x-slot name="pageSlug">purchased</x-slot>
        ...
        @case('admin.finance.top-ups')
            <x-slot name="pageSlug">top-ups</x-slot>
