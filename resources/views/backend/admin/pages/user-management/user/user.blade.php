<x-admin::app>
    ...
    @switch(Route::currentRouteName())
        ...
        @case('admin.um.user.all-seller')
            <x-slot name="pageSlug">sellers</x-slot>
        ...
        @case('admin.um.user.banned-user')
            <x-slot name="pageSlug">admin-users-banned</x-slot>
        ...
        @case('admin.um.user.all-buyer')
            <x-slot name="pageSlug">buyers</x-slot>
        ...
        @case('admin.um.user.pending-verification')
            <x-slot name="pageSlug">seller-verification-pending</x-slot>
        ...
        @case('admin.um.user.seller-verification.verified')
            <x-slot name="pageSlug">seller-verification-verified</x-slot>
        ...
        @case('admin.um.user.feedback')
            <x-slot name="pageSlug">feedback</x-slot>
