<x-admin::app>
    ...
    @switch(Route::currentRouteName())
        ...
        @case('admin.gm.game.config')
            <x-slot name="title">{{ __('Game Configuration') }}</x-slot>
            <x-slot name="breadcrumb">{{ __('Game Management / Game Configuration') }}</x-slot>
            <livewire:backend.admin.game-management.game.category-store :game="$data" />
        @break
